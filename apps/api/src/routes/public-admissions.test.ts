...
describe('Phase 15 public registration', () => {
  it('returns a public-safe academic context', async () => {
    vi.spyOn(publicAdmissionsService, 'context').mockResolvedValue({ schools: [], schoolYears: [], gradeLevels: [], sections: [], externalSchools: [], privacyNotice: { version: 'test', summary: 'test' } });
